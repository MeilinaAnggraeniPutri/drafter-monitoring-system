...
@section('breadcrumb')
    <x-dashboard::breadcrumb title="Infrastructure" page="Infrastructure" active="Infrastructure"
        route="{{ route('infrastructure.index') }}" />
@endsection
            ...
            <tbody>
                @forelse($infrastructures as $infrastructure)
                    <tr>
                        ...
                        <td>
                            <a href="#" data-bs-toggle="modal" data-bs-target="#modalFile"
                                data-pdf="{{ url('assets/infrastructures/' . $infrastructure->file_pdf) }}"
                                download>{{ $infrastructure->file_pdf }}</a>
                        </td>
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                    <li>
                                        <a class="dropdown-item"
                                            href="{{ route('infrastructure.show', $infrastructure->id) }}">
                                            Show
                                        </a>
                                    </li>
                                    @if (auth()->user()->id == $infrastructure->user_create)
                                        ...
                                        <li>
                                            <a class="dropdown-item" href="#"
                                                onclick="event.preventDefault(); document.getElementById('modal-form-delete-admin-{{ $infrastructure->id }}').submit()">
                                                Delete
                                            </a>
                                        </li>
                                    @endif
