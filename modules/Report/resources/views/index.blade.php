...
@section('content')
            ...
            <div class="flex-shrink-0">
                @if (auth()->user()->hasRole('User'))
                    <button type="button" class="btn btn-soft-primary btn-sm" data-bs-toggle="modal"
                        data-bs-target="#modal-form-add-report">
                                ...
                                @foreach ($report->upload_foto as $file)
                                    <div class="mb-1">
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#modalFoto"
                                            data-foto="{{ asset('assets/files/' . $file) }}">{{ $file }}</a>
                                    </div>
                                @endforeach
                            </div>
                        </th>
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                    <li>
                                        <a class="dropdown-item" href="#" data-bs-toggle="modal"
                                            data-bs-target="#modal-form-show-report-{{ $report->id }}">
                                            Detail
                                        </a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item" href="#" data-bs-toggle="modal"
                                            data-bs-target="#modal-form-edit-report-{{ $report->id }}">
                                            Edit
                                        </a>
                                    </li>
                                    @if (
                                        ...
                                        <li>
                                            <a class="dropdown-item" href="#"
                                                onclick="event.preventDefault(); document.getElementById('modal-form-delete-report-{{ $report->id }}').submit()">
                                                Delete
                                            </a>
                                        </li>
                                    @endif
    ...
    <div class="modal fade" id="modalFoto" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
