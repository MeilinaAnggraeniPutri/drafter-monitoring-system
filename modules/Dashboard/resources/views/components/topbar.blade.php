<header id="page-topbar">
    <div class="navbar-header">
        <div class="d-flex">
            ...
            <!-- App Search-->
            <form class="app-search d-none d-lg-block" action="" method="get" style="margin-top: 4.5rem;">
                <div class="position-relative">
                    <input type="text" class="form-control" placeholder="Search..." autocomplete="off"
                        id="search-options" value="" name="search">
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
                    ...
                    <div data-simplebar style="max-height: 230px;">
                        ...
                        <a href="{{ route('notivication.show', $notivication->id) }}"
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    ...
                    <img class="rounded-circle header-profile-user"
                        src="{{ $user->avatar ? asset('assets/user/image/' . $user->avatar) : '/assets/images/users/avatar-1.jpg' }}"
                        alt="Header Avatar">
